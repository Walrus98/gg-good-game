...
function useSwitch(originalProps = {}) {
  ...
  const ariaSwitchProps = (0, import_react20.useMemo)(() => {
  ...
  const [isPressed, setPressed] = (0, import_react19.useState)(false);
  ...
  const getThumbProps = (0, import_react19.useCallback)(
    (props2 = {}) => ({
      ...props2,
  ...
  const getThumbIconProps = (0, import_react19.useCallback)(
    (props2 = {
  ...
  const getStartContentProps = (0, import_react19.useCallback)(
    (props2 = {}) => ({
      width: "1em",
      height: "1em",
      ...props2,
  ...
  const getEndContentProps = (0, import_react19.useCallback)(
    (props2 = {}) => ({
      width: "1em",
      height: "1em",
      ...props2,
...
// node_modules/@nextui-org/switch/dist/chunk-VMWQTXAV.mjs
...
var Switch = forwardRef((props, ref) => {
  ...
  const clonedThumbIcon = typeof thumbIcon === "function" ? thumbIcon(getThumbIconProps({ includeStateProps: true })) : thumbIcon && (0, import_react21.cloneElement)(thumbIcon, getThumbIconProps());
  const clonedStartContent = startContent && (0, import_react21.cloneElement)(startContent, getStartContentProps());
  const clonedEndContent = endContent && (0, import_react21.cloneElement)(endContent, getEndContentProps());
  return (0, import_jsx_runtime.jsxs)(Component, { ...getBaseProps(), children: [
    (0, import_jsx_runtime.jsx)($5c3e21d68f1c4674$export$439d29a4e110a164, { elementType: "span", children: (0, import_jsx_runtime.jsx)("input", { ...getInputProps() }) }),
...
//# sourceMappingURL=chunk-YJFZP4KV.js.map
