...
} from "./chunk-QVUUIMZO.js";
import {
  useAriaButton
} from "./chunk-QT4UMSL4.js";
import {
  $458b0a5536c1a7cf$export$40bfa8c7b0832715
} from "./chunk-MSYCOHOU.js";
import {
...
var NavbarMenu = forwardRef((props, ref) => {
  ...
  const MenuWrapper = (0, import_react4.useCallback)(
    ({ children: children2 }) => {
      return (0, import_jsx_runtime.jsx)(Combination_default, { forwardProps: true, enabled: isMenuOpen, removeScrollBar: false, children: children2 });
    },
    [isMenuOpen]
  );
  const contents = disableAnimation ? (0, import_jsx_runtime.jsx)(MenuWrapper, { children: (0, import_jsx_runtime.jsx)(
    "ul",
    {
      ref: domRef,
  ...
  ) }) : (0, import_jsx_runtime.jsx)(AnimatePresence, { mode: "wait", children: isMenuOpen ? (0, import_jsx_runtime.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime.jsx)(MenuWrapper, { children: (0, import_jsx_runtime.jsx)(
    m.ul,
    {
      ref: domRef,
      layoutScroll: true,
...
function useMeasure() {
  ...
  const previousObserver = (0, import_react5.useRef)(null);
  const customRef = (0, import_react5.useCallback)((node) => {
...
var ResizablePanel = (0, import_react6.forwardRef)(
  (originalProps, ref) => {
...
var useScrollPosition = (props) => {
  ...
  const position = (0, import_react7.useRef)(
    isEnabled ? getScrollPosition(elementRef == null ? void 0 : elementRef.current) : { x: 0, y: 0 }
  );
  const throttleTimeout = (0, import_react7.useRef)(null);
  const handler = (0, import_react7.useCallback)(() => {
...
function useNavbar(originalProps) {
  ...
  const domRef = useDOMRef(ref);
  const prevWidth = (0, import_react8.useRef)(0);
  const navHeight = (0, import_react8.useRef)(0);
  const [isHidden, setIsHidden] = (0, import_react8.useState)(false);
  const handleMenuOpenChange = (0, import_react8.useCallback)(
    (isOpen) => {
...
// node_modules/@nextui-org/navbar/dist/chunk-FIYZROTF.mjs
...
var Navbar = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(NavbarProvider, { value: context, children: context.shouldHideOnScroll ? (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime3.jsx)(
    m.nav,
    {
...
var NavbarMenuToggle = forwardRef((props, ref) => {
  ...
  const srOnlyText = (0, import_react9.useMemo)(() => {
    if (srOnlyTextProp) {
...
//# sourceMappingURL=chunk-H32QOB54.js.map
