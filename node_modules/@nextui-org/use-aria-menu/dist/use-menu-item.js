...
function useMenuItem(props, state, ref) {
  ...
  let performAction = (e) => {
    ...
    if (e.target instanceof HTMLAnchorElement) {
      router.open(e.target, e, item == null ? void 0 : item.props.href, item == null ? void 0 : item.props.routerOptions);
    }
  };
  let role = "menuitem";
  if (!isTrigger) {
  ...
  let domProps = (0, import_utils2.filterDOMProps)(item.props, { isLink: !!((_c = item == null ? void 0 : item.props) == null ? void 0 : _c.href) });
  delete domProps.id;
  return {
    menuItemProps: {
      ...ariaProps,
